...
package magic // import "github.com/scusi/magic"
...
// NOTE: It is important that the most specific match comes first in the following Table,
// becuase the first match wins.

var prefixTable = []prefixEntry{
	// added by scusi
	// executables
	//{[]byte{0x4D, 0x5A, 0x90, 0x00, 0x03, 0x00, 0x00, 0x00}, "MZ Header found - Adobe Acrobat Plugin/DirecShow Filter/Audition graphic filter file"},
	...
	// ms office
	//{[]byte{0x50, 0x4B, 0x03, 0x04, 0x14, 0x00, 0x06, 0x00}, "Microsoft Office Open XML Format (OOXML) Document (DOCX, PPTX, XLSX)"},
	//{[]byte{}, ""},
